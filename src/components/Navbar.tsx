                ...
                {productsOpen && (
                  <div className="absolute top-full pt-2 left-1/2 -translate-x-1/2">
                    <div className="rounded-lg shadow-lg py-2 min-w-[200px] glassmorphism" style={{ background: "hsl(220 20% 12% / 0.95)" }}>
                      ...
                      <Link to="/speedmath" className="block px-4 py-2.5 hover:bg-[hsl(0_0%_100%_/_0.05)] transition-colors text-sm">
                        <div className="flex items-center gap-2">
                          <span className="text-gradient-speedmath font-semibold">Speed Math</span>
